<section class="container mt-5">
    ...
    <?php endif; ?>
    <?= form_open('Auth/login',['class' => 'form-signin','id'=>'login']) ?>
    ...
    <input type="submit" class="btn btn-primary pull-left" name="login">
    <a href="<?= base_url('auth/userRegistration')?>">Not registered yet? | Register</a>
    <?= form_close() ?>
</section>
